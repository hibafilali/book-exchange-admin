    ...
    return (
        <span className={className} style={{ display: 'inline-flex', alignItems: 'center', gap: `${4 * scale}px`, cursor: 'pointer' }}>
            ...
            <svg width={size * 1.2} height={size * 1.2} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M18 24 L30 24" stroke="#FF5722" strokeWidth="2.5" strokeLinecap="round" markerEnd="url(#arrow)" />
                <path d="M30 28 L18 28" stroke="#0F172A" strokeWidth="2.5" strokeLinecap="round" markerEnd="url(#arrow2)" />
                <defs>
                    <marker id="arrow" markerWidth="6" markerHeight="6" refX="5" refY="3" orient="auto">
                        <path d="M0,0 L6,3 L0,6" fill="#FF5722" />
                    </marker>
